...
class Player(PhysicsEntity):
    ...
    1: game -- Game -- The actual main class controlling the entire game
    
    2: pos -- Tuple(x, y) -- The position of the player in the world measured in pixels

    3: size -- Tuple(width, height) -- actual size of hitbox of the player

    4: sprite_offset -- Tuple(x, y) -- the offset from the top left of the player image to the top left of the hitbox
    """
